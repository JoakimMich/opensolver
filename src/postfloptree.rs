...
pub fn recursive_build(latest_action: Option<ActionType>, sizing_schemes: &SizingSchemes, current_node: &mut Node, range_manager: &RangeManager, current_board: &String) {
